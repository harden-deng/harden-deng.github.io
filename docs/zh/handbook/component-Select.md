...
![](images/Select_Features_pic1.png)
...
![](images/Select_Features_pic2.png)
...
| Multiple                        | Control whether multiple selection is enabled for the drop down                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                             |
| Searchable                      | Can input key word to fast identify option from the drop down list  if this attribute is enabled                                                                                                                                                                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                             |
| Option                          | To control the data source of the drop-down list:<br/>1.Static Data: Manually input the selection options<br/>2.Dynamic Data: Specify the data source from data maintained in List Management for the selection<br/> **List Selection:** choose where the data comes from<br/> **Filter Value:** input filter value if want to reduce the data range, the input filter value should meet the “filter value” maintained in List Management,leave it blank if you want to load all the data from the list |                                                                                                                                                                                                             |
